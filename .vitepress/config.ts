...
export default defineConfig({
  ...
  sitemap: {
    hostname: "https://webassemblybyexample.dev",
  },

  title: "WebAssembly by Example",
  description: "Starter WebAssembly examples",
  ...
  head: [
    ...
    [
      ...
      {
        rel: "license",
        href: "https://github.com/jcbhmr/webassemblybyexample.dev/blob/main/LICENSE",
      },
    ],
  ],
  ...
  themeConfig: {
    ...
    footer: {
      message:
        'Released under the <a href="https://github.com/jcbhmr/webassemblybyexample.dev/blob/main/LICENSE">0BSD License</a>.',
      copyright:
